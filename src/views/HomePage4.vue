  ...
  <a-row>
    <a-col span="4">
      <ul id="side">
        ...
        <router-link to="/home2" exact>
        <li id="air">空气监测</li>
        </router-link>
        <router-link to="/home3" exact>
        <li id="warning">预警信息</li>
        </router-link>
...
.router-link-exact-active li#uav{
    position: relative;
    top:0px;
    background-color:rgb(105,166,124,0.6);
    color: white;
}
