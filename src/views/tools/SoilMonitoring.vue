  ...
  <div style="width: 100%">
    ...
    <div style="margin-top: 20px; width: 100%">
      ...
      <a-row v-if="!loading" style="width: 100%">
        ...
        <a-row
          v-else
          style="text-align: center; width: 100%; margin: 10vh auto"
        >
          暂无数据
        </a-row>
        <a-row v-if="data && data.length !== 0" style="width: 100%">
          ...
          >
            ...
            <a-descriptions-item label="氮指数(mg/kg)">{{
              item.sensor_data.nitrogen
            }}</a-descriptions-item>
            <a-descriptions-item label="磷指数(mg/kg)">{{
              item.sensor_data.phosphorus
            }}</a-descriptions-item>
            <a-descriptions-item label="钾指数(mg/kg)">{{
              item.sensor_data.potassium
            }}</a-descriptions-item>
          </a-descriptions>
        </a-row>
      </a-row>
